...
public class PlaceCategorySeeder implements ApplicationRunner {
  ...
  private static final List<Seed> SEEDS = List.of(
      ...
      // 점수는 아직 대화로 확정 안 해서 전부 중립(50) - 나중에 채워 넣을 것.
      Seed.neutral("맛집", "식당(한식)", "🍚"),
      Seed.neutral("맛집", "식당(중식)", "🥟"),
      Seed.neutral("맛집", "식당(일식)", "🍣"),
      Seed.neutral("맛집", "식당(양식)", "🍝"),
      Seed.neutral("맛집", "식당(아시아음식)", "🍜"),
      Seed.neutral("맛집", "식당(분식)", "🌭"),
      Seed.neutral("맛집", "식당(뷔페)", "🍱"),

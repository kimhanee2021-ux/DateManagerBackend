...
public class PlaceCategorySeeder implements ApplicationRunner {
  ...
  private static final List<Seed> SEEDS = List.of(
      ...
      // 전시 (2026-08-20 성향점수 재검토안 전체 반영 - "도슨트"는 해설 중심이라 미적 최저·몰입 최저,
      // 대신 깊이는 최고로 재정의)
      new Seed("전시", "도슨트 전시", "🎧", 25, 25, 50, 15, 75, 50, 1, 35),
      ...
      Seed.neutral("축제", "계절축제", "🌸", 0, 40),
      Seed.neutral("축제", "불꽃/야간축제", "🎆", 0, 25),
      Seed.neutral("축제", "음식축제", "🥘", 0, 40),
      Seed.neutral("축제", "문화예술축제", "🎬", 0, 35),
